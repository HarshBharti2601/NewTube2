         ...
         render={({field})=>{
            ...
            <FormItem>
                <FormLabel>
                    ...
                    >
                        {generateDescription.isPending?<Loader2Icon className="animate-spin"/>
                        :<SparklesIcon/>}
         ...
         <FormField
          ...
          render={()=>(
            <FormItem>
                ...
                <FormControl>
                    <div className="p-0.5 border border-dashboard border-neutral-400 relative h-[84px] w-[153px] group">
                      <Image
